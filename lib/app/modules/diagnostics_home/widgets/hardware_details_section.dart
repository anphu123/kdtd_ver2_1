...
class HardwareDetailsSection extends StatelessWidget {
  const HardwareDetailsSection({super.key});
        ...
        children: [
          ...
          HardwareExpandable(
            ...
            children: [
              Obx(() {
                  final cameraSpecs =
                      Get.find<DiagnosticsHomeController>().info['camera_specs'] as Map? ?? {};
          ...
          HardwareExpandable(
            ...
            children: [
              Obx(() {
                  final sensorsInfo =
                      Get.find<DiagnosticsHomeController>().info['sensors'] as Map? ?? {};
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.grayE5E5E5.withValues(alpha: 0.2)),
      ),
      child: Column(
        children: [
          Material(
