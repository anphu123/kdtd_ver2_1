...
class _EarpieceTestPageState extends State<EarpieceTestPage> {
  ...
  Future<void> _start() async {
    ...
    _sub = ProximitySensor.events.listen((v) {
      if (v > 0) _nearOnce = true;
    });
  }

  Uint8List _genSineWavBytes({
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Padding(
          ...
          child: Text(
            'Áp điện thoại sát tai (cảm biến tiệm cận kích hoạt) và xác nhận nghe rõ.',
          ),
        ),
      ),
            ...
            children: [
              ...
              Expanded(
                child: FilledButton.icon(
                  onPressed: () => Navigator.pop(context, _nearOnce),
